...
- Iconos de lucide-react. Importación explícita, nunca barrels
- Preferir ESM y sintaxis moderna del navegador

## Creación de proyectos

- Si hay que crear un proyecto nuevo, usa Next.js (App Router)
- Comando recomendado:
  `pnpm create next-app@latest <project_name>`
- Configura TypeScript en modo estricto desde el inicio
- Tailwind CSS debe estar configurado desde el inicio
...
- Componentes específicos de la app en `/components/app`
- Lógica de negocio y utilidades en `/lib`
- Store de estado del cliente en `/lib/store`
- App Router obligatorio, no usar Pages Router
- Usar las nuevas convenciones de archivos: `loading.tsx`, `error.tsx`, `not-found.tsx`
